...
public class FruitDAOImpl extends BaseDAO<Fruit> implements FruitDAO {
    @Override
    public List<Fruit> getFruitList3(String keyword, Integer pageNo) {
    ...
    public int getFruitCount(String keyword) {
        Object object = super.executeComplexQuery("select count(*) from t_fruit where fname like ?", "%"+keyword+"%")[0];
